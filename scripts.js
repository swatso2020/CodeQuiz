...
//loop to print options to the screen
for(var i=0; i<testQuestions[currentQuestion].options.length; i++){
var listItem = document.createElement("li"); //creates entries for list
listItem.innerHTML = testQuestions[currentQuestion].options[i]
